<?php
/*
 Plugin Name: BP Search
Plugin URI:   https://tomas.zhu.bz/buddypress-angularjs-search-plugin/
Description: BP Search is  a fast and light member search plugin to help users search member more quick and do not need click submit button to refresh the BP members page, when users typed members name, we will show related members instantly in a drop-down member list, it drived by AngularJS.
Version: 1.3
Author: https://membersonly.top/
Author URI: https://membersonly.top/
Text Domain: tomas-buddypress-search
License: GPLv3 or later
*/
/*  Copyright 2016 - 2020 Tomas Zhu
